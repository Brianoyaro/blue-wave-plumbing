  ...
  if (!images || images.length === 0) {
    return (
      <div className="relative overflow-hidden rounded-2xl shadow-lg bg-gray-50 aspect-square sm:aspect-auto w-full">
        <img
          src={fallbackImage || "https://via.placeholder.com/400x300?text=No+Image"}
    ...
    >
      ...
      <div className="relative w-full h-full">
        <img
          ...
          onError={(e) => (e.currentTarget.src = fallbackImage || "https://via.placeholder.com/400x300?text=No+Image")}
        />
