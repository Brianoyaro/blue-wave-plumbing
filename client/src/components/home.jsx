      ...
      <section className="py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="rounded-2xl shadow-md hover:shadow-lg transition overflow-hidden bg-white">
            <img src="https://images.unsplash.com/photo-1600566752355-35792bedcfea?w=400&h=250&fit=crop" alt="PPR pipes & fittings" className="w-full h-48 object-cover" />
            <div className="p-6">
          ...
          <div className="rounded-2xl shadow-md hover:shadow-lg transition overflow-hidden bg-white">
            <img src="https://images.unsplash.com/photo-1581091870627-3c1c10e8e3be?w=400&h=250&fit=crop" alt="GI pipes & fittings" className="w-full h-48 object-cover" />
            <div className="p-6">
          ...
          <div className="rounded-2xl shadow-md hover:shadow-lg transition overflow-hidden bg-white">
            <img src="https://images.unsplash.com/photo-1590658006820-5f9b06d98e36?w=400&h=250&fit=crop" alt="Gutters & accessories" className="w-full h-48 object-cover" />
            <div className="p-6">
          ...
          <div className="rounded-2xl shadow-md hover:shadow-lg transition overflow-hidden bg-white">
            <img src="https://images.unsplash.com/photo-1564540574843-5472435c8baa?w=400&h=250&fit=crop" alt="Toilets & Accessories" className="w-full h-48 object-cover" />
            <div className="p-6">
          ...
          <div className="rounded-2xl shadow-md hover:shadow-lg transition overflow-hidden bg-white">
            <img src="https://images.unsplash.com/photo-1558618666-fb5a8c0c6f9a?w=400&h=250&fit=crop" alt="Waste pipes & Fittings" className="w-full h-48 object-cover" />
            <div className="p-6">
          ...
          <div className="rounded-2xl shadow-md hover:shadow-lg transition overflow-hidden bg-white">
            <img src="https://images.unsplash.com/photo-1607400201889-565b1ee75f8e?w=400&h=250&fit=crop" alt="General plumbing Items" className="w-full h-48 object-cover" />
            <div className="p-6">
